...
with open(os.path.join(here, 'episync', '__version__.py')) as f:
    exec(f.read(), about)
...
class CleanCommand(Command):
    ...
    CLEAN_FILES = '.mypy_cache ./docs/_build ./*.out ./*.log ./work/* ./build ./dist ./__pycache__ ./episync/cli/__pycache__ ./*/__pycache__ ./*.pyc ./ssh*py ./*.tgz ./.pytest_cache ./*.egg-info'.split(
        ' ')
...
setup(
    ...
    entry_points={
        'console_scripts': ['episync=episync.cli:cli']
    },
    classifiers=[
